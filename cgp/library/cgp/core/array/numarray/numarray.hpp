...
namespace cgp
{
    ...
    template <typename T>
    std::string type_str(numarray<T> const &);

    /** Display all elements of the numarray.*/
    template <typename T>
    std::ostream &operator<<(std::ostream &s, numarray<T> const &v);
     ...
     */
    template <typename T>
    std::string str(numarray<T> const &v, std::string const &separator = " ", std::string const &begin = "", std::string const &end = "");

    template <typename T>
    int size_in_memory(numarray<T> const &v);
    template <typename T>
    auto const *ptr(numarray<T> const &v);
    ...
    template <typename T>
    bool is_equal(numarray<T> const &a, numarray<T> const &b);
    /** Allows to check value equality between different type (float and int for instance). */
    template <typename T1, typename T2>
    bool is_equal(numarray<T1> const &a, numarray<T2> const &b);

    template <typename T>
    T max(numarray<T> const &v);
    template <typename T>
    T min(numarray<T> const &v);

    /** Compute average value of all elements of the numarray.*/
    template <typename T>
    T average(numarray<T> const &a);

    /** Math operators
     * Common mathematical operations between numarrays, and scalar or element values. */
    template <typename T>
    numarray<T> operator-(numarray<T> const &a);
    ...
    numarray<T> operator*(numarray<T> const &a, numarray<T> const &b);
    template <typename T>
    numarray<T> &operator*=(numarray<T> &a, float b);
    template <typename T>
    numarray<T> operator*(numarray<T> const &a, float b);
    template <typename T>
    numarray<T> operator*(float a, numarray<T> const &b);
...
#else
    template <typename T>
    void check_index_bounds(int, numarray<T> const &)
    {
    }
#endif
