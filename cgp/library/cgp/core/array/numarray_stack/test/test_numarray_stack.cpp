...
namespace cgp_test
{
    ...
    void test_numarray_stack()
    {
        ...
        // access size 2
        {
            ...
            assert_cgp_no_msg(a[0] == 1);
            assert_cgp_no_msg(a[1] == 2);
            assert_cgp_no_msg(a(0) == 1);
            assert_cgp_no_msg(a(1) == 2);
            assert_cgp_no_msg(a.at(0) == 1);
            assert_cgp_no_msg(a.at(1) == 2);
            assert_cgp_no_msg(cgp::get<0>(a) == 1);
            assert_cgp_no_msg(cgp::get<1>(a) == 2);
        }
        ...
        // access size 3
        {
            ...
            assert_cgp_no_msg(a[0] == 7);
            assert_cgp_no_msg(a[1] == 8);
            assert_cgp_no_msg(a[2] == -2);
            assert_cgp_no_msg(a(0) == 7);
            assert_cgp_no_msg(a(1) == 8);
            assert_cgp_no_msg(a(2) == -2);
            assert_cgp_no_msg(a.at(0) == 7);
            assert_cgp_no_msg(a.at(1) == 8);
            assert_cgp_no_msg(a.at(2) == -2);
            assert_cgp_no_msg(cgp::get<0>(a) == 7);
            assert_cgp_no_msg(cgp::get<1>(a) == 8);
            assert_cgp_no_msg(cgp::get<2>(a) == -2);
        }
        ...
        // access size 4
        {
            ...
            assert_cgp_no_msg(a[0] == 1);
            assert_cgp_no_msg(a[1] == 2);
            assert_cgp_no_msg(a[2] == 3);
            assert_cgp_no_msg(a[3] == 4);
            assert_cgp_no_msg(a(0) == 1);
            assert_cgp_no_msg(a(1) == 2);
            assert_cgp_no_msg(a(2) == 3);
            assert_cgp_no_msg(a(3) == 4);
            ...
            assert_cgp_no_msg(cgp::get<0>(a) == 1);
            assert_cgp_no_msg(cgp::get<1>(a) == 2);
            assert_cgp_no_msg(cgp::get<2>(a) == 3);
            assert_cgp_no_msg(cgp::get<3>(a) == 4);
        }
...

        {
            ...
            assert_cgp_no_msg(a[0].size() == 2);
            assert_cgp_no_msg(is_equal(a[0], {1, 2}));
            assert_cgp_no_msg(a[1].size() == 2);
            assert_cgp_no_msg(is_equal(a[1], {2, 3}));
            assert_cgp_no_msg(a[2].size() == 2);
            assert_cgp_no_msg(is_equal(a[2], {-1, 1}));
        }

        {
            cgp::numarray_stack<float, 16> b;
            assert_cgp_no_msg(cgp::is_equal(type_str(b), "numarray_stack<float,16>"));
            cgp::numarray_stack<cgp::numarray_stack<int, 5>, 6> c;
            assert_cgp_no_msg(cgp::is_equal(type_str(c), "numarray_stack<numarray_stack<int,5>,6>"));
        }
