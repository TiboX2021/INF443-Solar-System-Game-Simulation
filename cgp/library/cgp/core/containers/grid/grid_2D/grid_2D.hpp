...
namespace cgp
{
    ...
    template <typename T>
    std::string type_str(grid_2D<T> const &);

    /** Display all elements of the buffer.*/
    template <typename T>
    std::ostream &operator<<(std::ostream &s, grid_2D<T> const &v);
     ...
     */
    template <typename T>
    std::string str(grid_2D<T> const &v, std::string const &separator = " ", std::string const &begin = "", std::string const &end = "");

    /** Equality test between grid_2D */
    template <typename T1, typename T2>
    bool is_equal(grid_2D<T1> const &a, grid_2D<T2> const &b);

    /** Math operators
     * Common mathematical operations between buffers, and scalar or element values. */
    template <typename T>
    grid_2D<T> &operator+=(grid_2D<T> &a, grid_2D<T> const &b);

    template <typename T>
    grid_2D<T> &operator+=(grid_2D<T> &a, T const &b);
    template <typename T>
    grid_2D<T> operator+(grid_2D<T> const &a, grid_2D<T> const &b);
    template <typename T>
    grid_2D<T> operator+(grid_2D<T> const &a, T const &b);
    template <typename T>
    grid_2D<T> operator+(T const &a, grid_2D<T> const &b);
    ...
    grid_2D<T> &operator*=(grid_2D<T> &a, grid_2D<T> const &b);
    template <typename T>
    grid_2D<T> &operator*=(grid_2D<T> &a, float b);
    template <typename T>
    grid_2D<T> operator*(grid_2D<T> const &a, grid_2D<T> const &b);
    template <typename T>
    grid_2D<T> operator*(grid_2D<T> const &a, float b);
    template <typename T>
    grid_2D<T> operator*(float a, grid_2D<T> const &b);
