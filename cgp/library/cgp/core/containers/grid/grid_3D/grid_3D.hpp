...
namespace cgp
{
    ...
    template <typename T>
    std::string type_str(grid_3D<T> const &);
    template <typename T1, typename T2>
    bool is_equal(grid_3D<T1> const &a, grid_3D<T2> const &b);

    template <typename T>
    std::ostream &operator<<(std::ostream &s, grid_3D<T> const &v);
    template <typename T>
    std::string str(grid_3D<T> const &v, std::string const &separator = " ", std::string const &begin = "", std::string const &end = "");

    template <typename T>
    grid_3D<T> &operator+=(grid_3D<T> &a, grid_3D<T> const &b);
    template <typename T>
    grid_3D<T> &operator+=(grid_3D<T> &a, T const &b);
    template <typename T>
    grid_3D<T> operator+(grid_3D<T> const &a, grid_3D<T> const &b);
    template <typename T>
    grid_3D<T> operator+(grid_3D<T> const &a, T const &b);
    template <typename T>
    grid_3D<T> operator+(T const &a, grid_3D<T> const &b);
    ...
    grid_3D<T> &operator*=(grid_3D<T> &a, grid_3D<T> const &b);
    template <typename T>
    grid_3D<T> &operator*=(grid_3D<T> &a, float b);
    template <typename T>
    grid_3D<T> operator*(grid_3D<T> const &a, grid_3D<T> const &b);
    template <typename T>
    grid_3D<T> operator*(grid_3D<T> const &a, float b);
    template <typename T>
    grid_3D<T> operator*(float a, grid_3D<T> const &b);
...
namespace cgp
{
    ...
    template <typename T>
    T const &grid_3D<T>::operator[](int3 const &index) const
    {
    ...
    template <typename T>
    T &grid_3D<T>::operator[](int3 const &index)
    {
        check_index_bounds(index.x, index.y, index.z, *this);
        int const idx = offset_grid(index.x, index.y, index.z, dimension.x, dimension.y);
        return data[idx];
    ...
    template <typename T>
    T const &grid_3D<T>::operator()(int k1, int k2, int k3) const
    {
    ...
    template <typename T>
    T &grid_3D<T>::operator()(int k1, int k2, int k3)
    {
        check_index_bounds(k1, k2, k3, *this);
        int const idx = offset_grid(k1, k2, k3, dimension.x, dimension.y);
        return data[idx];
