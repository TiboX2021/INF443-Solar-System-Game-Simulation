...
namespace cgp
{
    ...
    template <typename T, int N1, int N2>
    std::string type_str(grid_stack_2D<T, N1, N2> const &);

    /** Display all elements of the buffer.*/
    template <typename T, int N1, int N2>
    std::ostream &operator<<(std::ostream &s, grid_stack_2D<T, N1, N2> const &v);

    /** Direct compiled-checked access to data */
    template <int idx1, int idx2, typename T, int N1, int N2>
    T const &element(grid_stack_2D<T, N1, N2> const &data);
    template <int idx1, int idx2, typename T, int N1, int N2>
    T &element(grid_stack_2D<T, N1, N2> &data);
     ...
     */
    template <typename T, int N1, int N2>
    std::string str(grid_stack_2D<T, N1, N2> const &v, std::string const &separator = " ", std::string const &begin = "", std::string const &end = "");

    /** Equality test between grid_2D */
    template <typename Ta, typename Tb, int Na1, int Na2, int Nb1, int Nb2>
    bool is_equal(grid_stack_2D<Ta, Na1, Na2> const &a, grid_stack_2D<Tb, Nb1, Nb2> const &b);

    /** Math operators
     * Common mathematical operations between buffers, and scalar or element values. */
    template <typename T, int N1, int N2>
    grid_stack_2D<T, N1, N2> &operator+=(grid_stack_2D<T, N1, N2> &a, grid_stack_2D<T, N1, N2> const &b);

    template <typename T, int N1, int N2>
    grid_stack_2D<T, N1, N2> &operator+=(grid_stack_2D<T, N1, N2> &a, T const &b);
    template <typename T, int N1, int N2>
    grid_stack_2D<T, N1, N2> operator+(grid_stack_2D<T, N1, N2> const &a, grid_stack_2D<T, N1, N2> const &b);
    template <typename T, int N1, int N2>
    grid_stack_2D<T, N1, N2> operator+(grid_stack_2D<T, N1, N2> const &a, T const &b);
    template <typename T, int N1, int N2>
    grid_stack_2D<T, N1, N2> operator+(T const &a, grid_stack_2D<T, N1, N2> const &b);
    ...
    grid_stack_2D<T, N1, N2> &operator*=(grid_stack_2D<T, N1, N2> &a, grid_stack_2D<T, N1, N2> const &b);
    template <typename T, int N1, int N2>
    grid_stack_2D<T, N1, N2> &operator*=(grid_stack_2D<T, N1, N2> &a, float b);
    template <typename T, int N1, int N2>
    grid_stack_2D<T, N1, N2> operator*(grid_stack_2D<T, N1, N2> const &a, grid_stack_2D<T, N1, N2> const &b);
    template <typename T, int N1, int N2>
    grid_stack_2D<T, N1, N2> operator*(grid_stack_2D<T, N1, N2> const &a, float b);
    template <typename T, int N1, int N2>
    grid_stack_2D<T, N1, N2> operator*(float a, grid_stack_2D<T, N1, N2> const &b);
    ...
    grid_stack_2D<T, N1, N3> multiply_matrix(grid_stack_2D<T, N1, N2> const &a, grid_stack_2D<T, N2, N3> const &b);
