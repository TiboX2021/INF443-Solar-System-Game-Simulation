...
namespace cgp
{
    ...
    mat4 inverse(mat4 const &m)
    {
        ...
        mat4 inv = mat4{
                       det(m.remove_row_column(0, 0)),
                       -det(m.remove_row_column(1, 0)),
                       det(m.remove_row_column(2, 0)),
                       -det(m.remove_row_column(3, 0)),
                       -det(m.remove_row_column(0, 1)),
                       det(m.remove_row_column(1, 1)),
                       -det(m.remove_row_column(2, 1)),
                       det(m.remove_row_column(3, 1)),
                       det(m.remove_row_column(0, 2)),
                       -det(m.remove_row_column(1, 2)),
                       det(m.remove_row_column(2, 2)),
                       -det(m.remove_row_column(3, 2)),
                       -det(m.remove_row_column(0, 3)),
                       det(m.remove_row_column(1, 3)),
                       -det(m.remove_row_column(2, 3)),
                       det(m.remove_row_column(3, 3)),
                   } /
                   d;
